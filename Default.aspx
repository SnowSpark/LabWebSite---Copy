<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Styles_Default" %>
...
<head runat="server">
        ...
        <meta name="description" content="وضع وصف محتوى الموقع">
    ...
    <body onload="slider();">
                ...
                <div class="left-nav">
                    ...
                    <div class="nav-div">
                        <ul>
                            ...
                            <li><a href="#" id = "l2" runat="server">about</a></li>
        ...
        <div class="row first-slide" id="first-slide">
            ...
            <div id="" class="slider col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 ">
                    <div id="gp1" runat ="server"><p>First Lab Clinical Laboratory</p><img src="gallery/img1.jpg"></div>
                    <div id="2"><p>First Lab Clinical Laboratory</p><img src="gallery/img2.jpg"></div>
                    <div id="3"><p>First Lab Clinical Laboratory</p><img src="gallery/img3.jpg"></div>
                    <div id="4"><p>First Lab Clinical Laboratory</p><img src="gallery/img4.jpg"></div>
                </div>   
            </div>
